...
const Contact: React.FC<Props> = (props) => {
  ...
  return (
    <Template className={classes.contact} footer={footer} socialMedia={socialMedia}>
      <Head
        title='Contact'
      ...
      <GridContainer>
        ...
        <Grid className={classes.wrap}>
          <Cell cols={7} colsM={8} className={classes.message}>
            {submitted && (
              <div className={classes.success}>
                <h3>Thank you</h3>
                <p>
                  We will reach out to the email you&apos;ve provided as soon as possible.
          ...
          <Cell cols={4} start={9} startM={1} colsM={8} className={classes.contactInfo}>
