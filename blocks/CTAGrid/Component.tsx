...
const CTAGrid: React.FC<any> = ({ actions }) => {
    ...
    <div className={classes.CTAGrid}>
      <ul>
        {actions?.map(({ headline, link, icon }, i) => (
          <li key={i} className={classes.actionWrap}>
              ...
              <GridContainer className={classes.gridContainer}>
                <Grid>
                  <Cell cols={12}>
                    ...
                    {i + 1 !== actions?.length && <div className={classes.separator} />}
                  </Cell>
                </Grid>
              </GridContainer>

              <Gutter className={classes.gutter} left>
                {/* @ts-ignore */}
                <BackgroundColor color='gray' className={classes.bg} />
              </Gutter>
            </Link>
          </li>
        ))}
